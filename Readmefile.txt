...
request1.php - utput courses which have more than # secondary topics.
 The information result should be sorted by the number # of secondary topics courses have, descending, then by the creatorsí name #(alphabetically), then by the coursesí name (alphabetically)
Done by the admin
